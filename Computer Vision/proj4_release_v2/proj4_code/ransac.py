...
def calculate_num_ransac_iterations(prob_success: float,
    ...
    # TODO: YOUR CODE HERE
    ############################################################################
    num_iterations = int(np.log(1-prob_success)/np.log(1-ind_prob_correct**sample_size))
    ############################################################################
    #                             END OF YOUR CODE
    ############################################################################
...
def ransac_projection_matrix(pts2d: np.ndarray,
    ...
    for _ in range(num_iterations):
        ...
        inliers = find_inliers(sampled_pts2d, sampled_pts3d, P_sample, inlier_threshold)
